...
| | **Prompt injection defense** | Scan tool results for indirect prompt injection: sanitize risky fields, optionally block high-risk results, using [defender](https://github.com/StackOneHQ/defender) by StackOne | :white_check_mark: [Docs](pydantic_ai_harness/prompt_injection_defender/) | [pydantic-ai-shields](https://github.com/vstorm-co/pydantic-ai-shields) (vstorm&#8209;co) |
