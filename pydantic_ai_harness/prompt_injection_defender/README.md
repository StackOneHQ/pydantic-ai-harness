...
[Overflowing Tool Output](../overflowing_tool_output/README.md)) is therefore
sanitized first.

## Relationship to guardrails

[Input & Output Guardrails](../guardrails/README.md) check the user prompt before
a run and the agent output after it, using logic you write. `PromptInjectionDefender`
checks the tool results that arrive during a run, using defender's detector. The
